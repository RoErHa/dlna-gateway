#!/usr/bin/env python3
"""
dlna_library_browse.py — `BrowseMixin`: every read path the PWA,
the Naim UPnP tree and the Subsonic API browse through — artists,
albums, genres, decades, the letter bar, FTS5 search, and the
play-count-biased radio picker.
